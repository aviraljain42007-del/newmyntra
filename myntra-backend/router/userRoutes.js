...
const { getall, newsignup, checklogin, seedetails, getMe, logout, addToCart, getCart, removeFromCart } = require("../controller/userController");
...
userrouter.delete("/delete/:productId", verifyToken, removeFromCart);
